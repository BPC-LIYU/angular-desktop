    ...
    .factory("api", function (httpReq) {
        var apis = {
            ...
            'nf': {
                ...
                // 获取上传文件的url信息
                //  access_type:必填:文件访问类型, filename:必填:文件名称, filetype:必填:文件类型
            ...
            'org': {
                ...
                // 删除部门主管
                //  group_id:必填:部门id, org_id:必填:组织id, user_id:必填:用户id
                'add_aide_group': 'func',
                ...
                // 创建部门
                //  aide_id:非必填:主管id, charge_id:非必填:主管id, group_id:非必填:部门id, is_create_talk_group:非必填:是否创建部门群, name:非必填:部门名称, org_id:必填:组织id
                'create_group': 'func',
            
                // 上传组织头像
                //  nsfile_id:必填:文件id, org_id:必填:组织id
                'create_org_headicon': 'func',
                ...
                // 查询组织中的未部门成员
                //  group_id:非必填:部门id, org_id:必填:组织id
                ...
                // 申请加入组织
                //  org_id:必填:组织id, page_index:非必填:页码, page_size:非必填:页长度
                'query_apply_organization_list': 'func',
            
                // 查询组织中的部门列表,顶级部门
                //  group_id:必填:部门id, org_id:必填:组织id, page_index:非必填:页码, page_size:非必填:页长度
                ...
                // 删除部门主管
                //  group_id:必填:部门id, org_id:必填:组织id
                ...
                // 修改部门的信息
                //  group_id:必填:部门id, icon_url:非必填:头像, name:非必填:部门名称, org_id:必填:组织id, parent_id:非必填:父级部门id
                'update_group': 'func',
